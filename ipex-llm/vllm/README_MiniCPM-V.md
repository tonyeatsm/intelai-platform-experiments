...
modelscope download --model OpenBMB/MiniCPM-V-2_6 --local_dir /root/ipex-llm/models/vllm/MiniCPM-V-2_6
modelscope download --model OpenBMB/MiniCPM-V-4_5 --local_dir /root/ipex-llm/models/vllm/MiniCPM-V-4_5
...
numactl -C 0-11 python -m ipex_llm.vllm.xpu.entrypoints.openai.api_server \
  --port 8000 \
  --model "/root/ipex-llm/models/vllm/MiniCPM-V-4_5/" \
  ...
  "messages": [
    {
      ...
      "content": [
        ...
        },
        {
          "type": "image_url",
          "image_url": {
            "url": "/root/ipex-llm/datasets/camera_offset/test1.png"
          }
        }
      ]
    }
    ...
    },
    {
      ...
      "content": [
        ...
        },
        {
          "type": "image_url",
          "image_url": {
            "url": "/root/ipex-llm/datasets/camera_offset/test2.png"
          }
        }
      ]
    },
    ...
    },
    {
      ...
      "content": [
        ...
        },
        {
          "type": "image_url",
          "image_url": {
            "url": "/root/ipex-llm/datasets/camera_offset/test3.png"
          }
        }
      ]
    }
